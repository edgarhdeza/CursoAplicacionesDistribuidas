	...
	public class ClientPreferencesServices
	{
		...
		public async Task<bool> ToogleDarkModeAsync()
		{
			...
			if (preferences is not null)
			{
				...
				await localStorageService.SetItemAsync<ClientPreference>("clientPreferences", preferences);
		...
		{
			var preferences = await localStorageService.GetItemAsync<ClientPreference>("clientPreferences") ?? new ClientPreference();
